...
/**
 * LinkedList to organize or store data
...
public class DoublyLinkedList<E> implements Iterable 
{
    ...
    {
        DLListIterator<E> iterator = new DLListIterator();
        return iterator;
    }

    /**
     * Iterator class for DoublyLinkedLists
     * 
     * @author Faizan Hasnany fhasnany
     * @author Daniel Xu xudy13
     * @author Jonathan Yu jyu96
    ...
    private static class Node<E> 
    {
         ...
         *
         * @param d data to be put inside the node
         */
        public Node(E d) 
        {
            data = d;
         ...
         *
         * @return returns node before this one
         */
         ...
         *
         * @return returns data in the node
         */
        public E getData() 
        {
            return data;
